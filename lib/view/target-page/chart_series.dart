class FakeChartSeries {
  ...
  Map<DateTime, double> createLineAlmostSaveValues() {
    var day = 7;
    Map<DateTime, double> data = {};
    data[DateTime.now().subtract(Duration(days: -day * 1))] = 1.0;
    data[DateTime.now().subtract(Duration(days: -day * 2))] = 2.0;
    data[DateTime.now().subtract(Duration(days: -day * 3))] = 8.0;
    data[DateTime.now().subtract(Duration(days: -day * 4))] = 4.0;
    data[DateTime.now().subtract(Duration(days: -day * 5))] = 7.0;
    data[DateTime.now().subtract(Duration(days: -day * 6))] = 6.0;
    return data;
  }
