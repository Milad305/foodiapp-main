...
import 'package:salamatiman/widgets/fl_animated_linechart/chart/chart_line.dart';
import 'package:salamatiman/widgets/fl_animated_linechart/chart/chart_point.dart';
import 'package:salamatiman/widgets/fl_animated_linechart/chart/datetime_chart_point.dart';
import 'package:salamatiman/widgets/fl_animated_linechart/chart/datetime_series_converter.dart';
import 'package:salamatiman/widgets/fl_animated_linechart/chart/highlight_point.dart';
import 'package:salamatiman/widgets/fl_animated_linechart/common/dates.dart';
import 'package:salamatiman/widgets/fl_animated_linechart/common/pair.dart';
import 'package:salamatiman/widgets/fl_animated_linechart/common/text_direction_helper.dart';
...
class LineChart {
  ...
  void initialize(double widthPX, double heightPX, TextStyle style) {
    ...
    for (int axisIndex = 0; axisIndex < indexToUnit.length; axisIndex++) {
      ...
      for (int c = 0; c <= (stepCount + 1); c++) {
        ...
        TextSpan span = new TextSpan(
            style: style, text: axisValueString.toString().toPersianDigit());
    ...
    for (int c = 0; c <= (stepCount + 1); c++) {
      ...
      TextSpan span = new TextSpan(
          style: style,
          text: c < stepCount + 2
              ? _formatDateTime(tick, Duration(seconds: 0))
              : "");
      TextPainter tp = new TextPainter(
          text: span,
  ...
  String _formatDateTime(DateTime dateTime, Duration duration) {
    var myTime = dateTime.toString().toPersianDate().toString().split("/");
    return myTime[1] + "/" + myTime[2];
  }

  String DayToDayName(int id) {
    if (id < 10) {
      switch (id) {
        case 1:
          return "اول";
    ...
    } else if (id > 19 && id < 100) {
      int myID = int.parse(id.toString().split("")[0].toString());
      int myID2 = int.parse(id.toString().split("")[1].toString());
      switch (myID) {
        case 2:
          return "بیست" + DayToDayNameNumber2(myID2);
        case 3:
          return "سی" + DayToDayNameNumber2(myID2);
        case 4:
          return "چهل" + DayToDayNameNumber2(myID2);
        case 5:
          return "پنجاه" + DayToDayNameNumber2(myID2);
        case 6:
          return "شصت" + DayToDayNameNumber2(myID2);
        case 7:
          return "هفتاد" + DayToDayNameNumber2(myID2);
        case 8:
          return "هشتاد" + DayToDayNameNumber2(myID2);
        case 9:
          return "نود" + DayToDayNameNumber2(myID2);
      }
    } else if (id > 99 && id < 1000) {
      int myID = int.parse(id.toString().split("")[0].toString());
      int myID2 = int.parse(id.toString().split("")[1].toString());
      int myID3 = int.parse(id.toString().split("")[2].toString());
      switch (myID) {
        case 1:
          return "صد" + DayToDayNameNumber2(myID3);
        case 2:
          return "دویست" +
              DayToDayNameNumber2(myID2) +
              DayToDayNameNumber2(myID3);
        case 3:
          return "سیصد" +
              DayToDayNameNumber2(myID2) +
              DayToDayNameNumber2(myID3);
        ...
        case 7:
          return "هفتصد" +
              ...
              DayToDayNameNumber2(myID3);
        case 8:
          return "هشتصد" + DayToDayNameNumber2(myID3);
        case 9:
          return "نهصد" + DayToDayNameNumber2(myID3);
      }
    }
    return "";
  }

  DayToDayNameNumber2(id) {
    switch (id) {
      case 0:
        return "م";
      case 1:
  ...
  DayToDayNameNumber3(id) {
    return DayToDayNameNumber2(id);
  }
